...
if (!process.env.OPENAI_API_KEY) {
  if (process.env.NODE_ENV === 'production') {
    ...
    console.warn('⚠️ OPENAI_API_KEY non définie en développement - Les fonctionnalités IA seront désactivées');
    console.log('💡 Pour activer les fonctionnalités IA, ajoutez OPENAI_API_KEY dans votre fichier .env');
  }
}
